...
namespace NotepadCSharp
{
    public class MainForm : Form
    {
        ...
        // Использование паттерна комманда
        ...
        // Пункт меню Add Accembly - добавляем сборку
        ...
        // Пункт меню Run Macro - запуск макроса
        ...
        private void Run_Macro(string filename)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //В качестве аргументf программы возьмем наше текстовое поле, над которым можно производить манипуляции
                    object[] args = {form.richTextBox1};
                    //Вызываем код и передаем ему в качестве параметров наш объект - класс Program и массив аргументов
